  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (err.code === 'auth/popup-closed-by-user' || err.code === 'auth/cancelled-popup-request') {
        // User closed or dismissed the popup intentionally; do not log as an application error
        console.info('Google sign-in dismissed by user');
        setError(null);
      } else {
        ...
        if (err.code === 'auth/unauthorized-domain') {
          ...
          setError('Network error during Google sign-in. Please verify your connection.');
        } else {
